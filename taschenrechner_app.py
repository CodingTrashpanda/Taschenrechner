...
btn_back = tk.Button(root, text="<", command=lambda: text_result.delete("end-2c", "end"), width=5, font=("Arial", 14))
btn_back.grid(row=2, column=4)
btn_equals = tk.Button(root, text="=", command=evaluate_calculation, width=5, background="#252525", foreground="white", font=("Arial", 14))
